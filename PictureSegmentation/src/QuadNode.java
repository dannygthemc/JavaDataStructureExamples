...
protected QuadNode<T> northEast,northWest,southEast,southWest,parent;
...
public void setParent(QuadNode<T> node){
this.parent=node;
}
...
public void setNorthEast(QuadNode<T> node){
this.northEast=node;
}
public void setNorthWest(QuadNode<T> node){
this.northWest=node;
}
public void setSouthEast(QuadNode<T> node){
this.southEast=node;
}
public void setSouthWest(QuadNode<T> node){
this.southWest=node;
}
// getters
public int getX(){
